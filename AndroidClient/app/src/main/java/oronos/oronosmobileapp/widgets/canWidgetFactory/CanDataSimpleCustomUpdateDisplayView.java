...
/**
 * CanDataSimpleCustomUpdateDisplayView.java
 * Class qui implemente une vue can qui possède une customUpdate
 */
public class CanDataSimpleCustomUpdateDisplayView extends CanDataSimpleDisplayView {

    private String customUpdate;

    public CanDataSimpleCustomUpdateDisplayView(Context context, CanWidgetParams canWidgetParams) {
        super(context, canWidgetParams);
        customUpdate = canWidgetParams.customUpdate;
    ...
    protected String getDataToDisplay(Message.CanData protoMessage) {
        return protoMessage.getUpdatedDataMap().get(customUpdate);
    }
